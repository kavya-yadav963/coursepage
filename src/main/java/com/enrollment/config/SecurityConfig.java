    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/courses", "/api/courses/{id}").permitAll() // Allow public viewing of courses
                        ...
                        .requestMatchers("/api/courses/{courseId}/addStudent/{studentId}/byTeacher/{teacherId}").hasRole("TEACHER")
                        .requestMatchers("/api/courses/{courseId}/removeStudent/{studentId}/byTeacher/{teacherId}").hasRole("TEACHER")
